...
class ItemRepositoryTest {
    ...
    public void queryDslTest() {
        this.createItemList();
        JPAQueryFactory queryFactory = new JPAQueryFactory(em); // 쿼리를 동적으로 생성. 파라미터로 EntityManager를 넣음
        ...
        List<Item> itemList = query.fetch();    // 쿼리 결과를 list로 반환. fetch() 실행 시점에 쿼리문이 실행됨.
